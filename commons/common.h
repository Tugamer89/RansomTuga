...
const std::string badPrograms[] = {
	(std::string)skCrypt("Taskmgr.exe"),
	(std::string)skCrypt("procexp.exe"),
	(std::string)skCrypt("procexp64.exe"),
	(std::string)skCrypt("procexp64a.exe"),
	(std::string)skCrypt("AnVir.exe"),
	(std::string)skCrypt("anvir64.exe"),
	(std::string)skCrypt("anvirlauncher.exe"),
	(std::string)skCrypt("VirusTotalUpload.exe"),
	(std::string)skCrypt("ProcessHacker.exe"),
	(std::string)skCrypt("dumpcap.exe"),
	(std::string)skCrypt("Wireshark.exe"),
	(std::string)skCrypt("decompile.exe"),
	(std::string)skCrypt("ollydbg.exe"),
	(std::string)skCrypt("tcpview.exe"),
	(std::string)skCrypt("autoruns.exe"),
	(std::string)skCrypt("autorunsc.exe"),
	(std::string)skCrypt("filemon.exe"),
	(std::string)skCrypt("procmon.exe"),
	(std::string)skCrypt("regmon.exe"),
	(std::string)skCrypt("idaq.exe"),
	(std::string)skCrypt("idaq64.exe"),
	(std::string)skCrypt("ImmunityDebugger.exe"),
	(std::string)skCrypt("HookExplorer.exe"),
	(std::string)skCrypt("ImportREC.exe"),
	(std::string)skCrypt("PETools.exe"),
	(std::string)skCrypt("LordPE.exe"),
	(std::string)skCrypt("SysInspector.exe"),
	(std::string)skCrypt("proc_analyzer.exe"),
	(std::string)skCrypt("sysAnalyzer.exe"),
	(std::string)skCrypt("sniff_hit.exe"),
	(std::string)skCrypt("windbg.exe"),
	(std::string)skCrypt("joeboxcontrol.exe"),
	(std::string)skCrypt("joeboxserver.exe"),
	(std::string)skCrypt("ResourceHacker.exe"),
	(std::string)skCrypt("x32dbg.exe"),
	(std::string)skCrypt("x64dbg.exe"),
	(std::string)skCrypt("Fiddler.exe"),
	(std::string)skCrypt("httpdebugger.exe")
}; // Tasks to kill
